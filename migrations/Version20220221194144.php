 ...
 */
final class Version20220221194144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE libro (id INT AUTO_INCREMENT NOT NULL, editorial_id INT NOT NULL, titulo VARCHAR(255) NOT NULL, anio_publicacion INT NOT NULL, isbn VARCHAR(255) NOT NULL, paginas INT DEFAULT NULL, sinopsis LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_5799AD2BCC1CF4E6 (isbn), INDEX IDX_5799AD2BBAF1A24D (editorial_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
